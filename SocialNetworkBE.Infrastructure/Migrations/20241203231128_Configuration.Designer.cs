...
namespace SocialNetworkBE.Infrastructure.Migrations
{
    ...
    [Migration("20241203231128_Configuration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialNetworkBE.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SocialNetworkBE.Domain.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SocialNetworkBE.Domain.Entities.ApplicationUser", b =>
                {
                    b.HasOne("SocialNetworkBE.Domain.Entities.Player", "Player")
                        ...
                        .HasForeignKey("SocialNetworkBE.Domain.Entities.ApplicationUser", "PlayerId")
                    ...
                    b.OwnsOne("SocialNetworkBE.Domain.Value_Objects.MatchTeams", "Teams", b1 =>
                        {
                            ...
                            b1.Property<Guid>("TeamAId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<Guid>("TeamBId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasOne("SocialNetworkBE.Domain.Entities.Team", "TeamA")
                                .WithMany()
                                .HasForeignKey("TeamAId")
                                .OnDelete(DeleteBehavior.Restrict)
                                .IsRequired();

                            b1.HasOne("SocialNetworkBE.Domain.Entities.Team", "TeamB")
                                .WithMany()
            ...
            modelBuilder.Entity("SocialNetworkBE.Domain.Entities.TeamMembership", b =>
                {
                    ...
                    b.HasOne("SocialNetworkBE.Domain.Entities.Team", "Team")
                        .WithMany()
                        .HasForeignKey("TeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
